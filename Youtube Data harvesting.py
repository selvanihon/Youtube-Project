...
##SQL Data insertion 
Engine=create_engine("mysql+pymysql://root:Moni1234@localhost/youtube")
...
uri = "mongodb+srv://Porselvan:Selvan567@cluster0.vuk2oaz.mongodb.net/?retryWrites=true&w=majority"
client = MongoClient(uri, server_api=ServerApi('1'))
client.admin.command('ping')
a=MongoClient("mongodb+srv://Porselvan:Selvan567@cluster0.vuk2oaz.mongodb.net/?retryWrites=true&w=majority")
